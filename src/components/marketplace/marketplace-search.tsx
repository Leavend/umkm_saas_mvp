...
>(({ searchQuery, onSearchChange, placeholder = "Search prompts...", className, ...props }, ref) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="relative w-full">
      ...
      <input
        ...
        className={cn(
          "focus-visible:ring-brand-500/50 w-full rounded-full border border-slate-200 py-2 pl-9 pr-8 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-50 sm:py-2.5 sm:pl-10 sm:pr-10",
