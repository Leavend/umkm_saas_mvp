...
import { useTranslations, useLocalePath } from "~/components/language-provider";
...
export function CreditsDisplay({ credits }: { credits: number | null }) {
  ...
  return (
    <Link href={toLocalePath("/dashboard/top-up")} className="cursor-pointer">
      <div className="group flex items-center gap-2">
        <div className="flex items-center gap-1.5">
          <div className="relative">
            <Coins className="text-brand-600 group-hover:text-brand-500 h-4 w-4 transition-colors duration-200" />
