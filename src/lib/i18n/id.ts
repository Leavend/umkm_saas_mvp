...
export const id = {
  common: {
    ...
    errors: {
      ...
      insufficientCredits:
        "Kredit tidak cukup. Silakan beli lebih banyak kredit.",
  ...
  marketplace: {
    emptySearch: {
      ...
      description: "Tidak menemukan yang Anda cari? Minta prompt khusus!",
      placeholder: "Deskripsikan prompt yang Anda butuhkan...",
      categoryLabel: "Kategori (opsional)",
      submit: "Kirim Permintaan",
      submitting: "Mengirim...",
      success: "Permintaan terkirim! Kami akan meninjau segera.",
      error: "Gagal mengirim permintaan. Silakan coba lagi.",
      descriptionRequired: "Harap deskripsikan yang Anda butuhkan",
      helperText:
        "Kami akan meninjau permintaan Anda dan menambahkannya ke marketplace jika memungkinkan.",
    },
  ...
  promptFeedback: {
    question: "Apakah prompt ini membantu?",
    thumbsUp: "Ya, membantu",
    thumbsDown: "Tidak membantu",
